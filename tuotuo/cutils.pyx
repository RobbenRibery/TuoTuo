...
def _dirichlet_expectation_1d(
    cnp.ndarray[floating, ndim=1] doc_topic,
    floating doc_topic_prior,
    cnp.ndarray[floating, ndim=1] out
):
...
def _dirichlet_expectation_2d(cnp.ndarray[floating, ndim=2] arr):
    """
    ...
    cdef cnp.ndarray[dtype = floating, ndim=2] d_exp
